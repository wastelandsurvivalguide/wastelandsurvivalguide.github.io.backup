...
with the sole exception of the totally optional *Discord Rich Presence*.

### Utilities Separator
Right-click in MO2's left pane and choose "Create a separator". Name it *Utilities* and organize
